...
//
// -----------------------------------------------------------------------------
H5Studio::H5Studio(QWidget *parent) :
  QMainWindow(parent),
#if defined(Q_WS_WIN)
...
H5Studio::~H5Studio()
{
//  std::cout << "H5Studio::~H5Studio()" << std::endl;
  if (this->_fileId > 0)
  {
...
// -----------------------------------------------------------------------------
void H5Studio::closeEvent(QCloseEvent *event)
{
 // std::cout << "H5Studio::closeEvent(QCloseEvent *event)" << std::endl;
...
//
// -----------------------------------------------------------------------------
void H5Studio::dragEnterEvent(QDragEnterEvent* e)
{
...
//
// -----------------------------------------------------------------------------
void H5Studio::dropEvent(QDropEvent* e)
{
  const QMimeData* dat = e->mimeData();
  QList<QUrl> urls = dat->urls();
  QString file = urls.count() ? urls[0].toLocalFile() : QString();
...
//
// -----------------------------------------------------------------------------
void H5Studio::focusInEvent(QFocusEvent* event)
{
  //TODO: Implement this
...
//
// -----------------------------------------------------------------------------
void H5Studio::focusOutEvent(QFocusEvent* event)
{
  //TODO: Implement this
...
// -----------------------------------------------------------------------------
void H5Studio::writeSettings()
{
#if defined (Q_OS_MAC)
  QSettings prefs(QSettings::NativeFormat, QSettings::UserScope, "MXA", "H5Studio", this);
#else
  QSettings prefs(QSettings::IniFormat, QSettings::UserScope, "MXA", "H5Studio", this);
#endif
...
//
// -----------------------------------------------------------------------------
void H5Studio::updateRecentFileList(const QString &file)
{
...
//
// -----------------------------------------------------------------------------
void H5Studio::actionOpen_triggered()
{
...
//
// -----------------------------------------------------------------------------
void H5Studio::actionClose_triggered() {
  std::cout << "H5Studio::on_actionClose_triggered" << std::endl;
  qint32 err = -1;
...
//
// -----------------------------------------------------------------------------
void H5Studio::on_actionShow_Properties_triggered()
{
...
//
// -----------------------------------------------------------------------------
void H5Studio::openHDF5File(QString &hdfFile)
{
  ...
  {
    H5Studio* mainWindow = new H5Studio;
...
//
// -----------------------------------------------------------------------------
qint32 H5Studio::_checkDirtyDocument()
{
  qint32 err = 1;
...
//
// -----------------------------------------------------------------------------
void H5Studio::initWithFile(const QString &hdfFile)
{
  //std::cout << "H5Studio::initWithFile" << std::endl;
...
//
// -----------------------------------------------------------------------------
std::string H5Studio::generateHDFPath()
{
...
//
// -----------------------------------------------------------------------------
void H5Studio::_updateViewFromHDFPath(std::string dataPath)
{
...
//
// -----------------------------------------------------------------------------
void H5Studio::hdfTreeView_currentChanged(const QModelIndex & current, const QModelIndex & previous)
{
...
//
// -----------------------------------------------------------------------------
void H5Studio::addRow(QTableWidget* table, int row, const QString &key, const QString &value)
{
...
//
// -----------------------------------------------------------------------------
herr_t H5Studio::updateAttributeTable(const QString &path)
{
  std::string datasetPath = path.toStdString();
  //std::cout << "HDFGraphicsDelegate::displayHDFData: " << datasetPath << std::endl;
...
//
// -----------------------------------------------------------------------------
void H5Studio::hdfTreeView_doubleClicked(const QModelIndex & index)
{
  //Check to make sure we have a data file opened
  if (this->_fileId < 0)
  {
...
//
// -----------------------------------------------------------------------------
IH5DataWindow* H5Studio::findDataWindow(const QString &hdfPath)
{
...
//
// -----------------------------------------------------------------------------
void H5Studio::closeAllChildWindows()
{
    //QString canonicalFilePath = QFileInfo(fileName).canonicalFilePath();
