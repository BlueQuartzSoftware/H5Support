 ...
 * @class H5Studio H5Studio.h H5Studio.h
 */
class H5Studio : public QMainWindow, private Ui::H5Studio
{
  Q_OBJECT;


public:
  H5Studio(QWidget *parent = 0);
...
private:
  ...
  ~H5Studio();
  H5Studio(const H5Studio&);   //Copy Constructor Not Implemented
  void operator=(const H5Studio&); //Copy Assignment Not Implemented
};
